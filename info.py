...
# ============================
SESSION = environ.get('SESSION', 'rajbot')   # Session name for the bot
API_ID = int(environ.get('API_ID', '27084955')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '91c88b554ab2a34f8b0c72228f06fc0b')  # API Hash from my.telegram.org
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5804953849').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002795064458').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002691173535'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002691173535'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002870973266'))  # Premium logs channel id
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002723743584').split()] #(make sure bot is admin)
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002255543570')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002724097546')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/raj_support_group')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003083333651")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1003083333651")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/2wo.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'scan and pay')    # Owner UPI ID for payments
...
DATABASE_NAME = environ.get('DATABASE_NAME', "rajdb") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'raj_files') # Collection name (default: dreamcinezone_files)
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003083333651'))  # Notification of sent to your channel
DREAMXBOTZ_IMAGE_FETCH = bool(environ.get('RA_IMAGE_FETCH', True))  # On (True) / Off (False)
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002885071921')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002746487551')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/raj_dev_01")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/raj_dev_01")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/raj_dev_01")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", ".in") # Shortener website
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+u4cmm3JmIrFlNzZl') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/raj_dev_01') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+YZ7qQ1Ahx-M1MDdl') # Update channel link for the bot
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'raj_dev_01'))
MULTI_CLIENT = False
name = str(environ.get('name', 'raj_dev_01'))
